% -*-coding: koi8-r;-*-
% $Id: Thesis.tex,v 1.14 2005-02-10 20:58:08 evlad Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Главный файл
...
\chapter{Обзор и анализ методов нейросетевого управления}
%\chapter{Нейронные сети в системах управления}
\input{Part1_New.tex}

% Глава 2 - Стохастическое оптимальное управление
\chapter{Методика нейросетевого оптимального управления}
\input{Part2.tex}

% Глава 3 - Сравнительные эксперименты с ПИД, Винеровским и нейросетевым
%           оптимальными регуляторами
\chapter{Сравнительные эксперименты с ПИД, Винеровским и нейросетевым
         оптимальными регуляторами}
\input{Part3.tex}

% Глава 4 - Нейросетевое управление в нестационарных условиях
\chapter{Нейросетевое управление в нестационарных условиях}
%\input{Part?.tex}

% Глава 5 - Управление мобильным роботом
\chapter{Управление мобильным роботом}
%\input{Part4.tex}

% Глава 6 - Программный комплекс обучения студентов методам
% использования нейронных сетей в системах управления
% \chapter{Инструментальные программные средства}
\chapter{Программный комплекс обучения студентов ...}
%\input{Part4.tex}
