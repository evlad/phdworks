...
\usepackage[
  ...
  top=2cm, bottom=2cm, headsep=1cm, footskip=1cm,
% Dual side printing
  left=1.8cm, right=1.7cm
% Single side printing (GOST version of thesis)
...
% /usr/share/texmf/bibtex/bst/disser/gost705s.bst ; sudo mktexlsr
