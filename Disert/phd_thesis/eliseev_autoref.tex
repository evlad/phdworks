...
Ведущая организация:   & & ОАО ``Газпром автоматизация'', Россия, 119435, г.Москва, а/я 641, Саввинская набережная, д. 25-27, строение 3\\
\end{tabularx}

\vskip2ex\noindent
Защита состоится \datefield{} в \rule[0pt]{1cm}{0.5pt} часов на
заседании диссертационного совета Д212.157.08 при Национальном
исследовательском университете МЭИ, расположенном по адресу: 111250,
Москва, Е-250, Красноказарменная улица, дом ????14.
...
списка литературы из 84 наименований, включает 218 страниц
